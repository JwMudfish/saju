...
hour.hourPillarSky = function (hour, minute, dayGanji, summerTime, seoulTime) {
  let result;
  let dayGanjiArray = [];
  ...
  if (dayGanji === "갑" || dayGanji === "기") {
    dayGanjiArray = gabgi;
  } else if (dayGanji === "을" || dayGanji === "경") {
    dayGanjiArray = ulgung;
  } else if (dayGanji === "병" || dayGanji === "신") {
    dayGanjiArray = byongsin;
  } else if (dayGanji === "정" || dayGanji === "임") {
    dayGanjiArray = jungim;
  } else if (dayGanji === "무" || dayGanji === "계") {
    dayGanjiArray = muje;
  }
  //자시
