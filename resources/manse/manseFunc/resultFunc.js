...
const juljungiNew = require('../julgiJunggi/juljunggiNew');
...
const hapChung = require('../hapChug/hapChungIF');
...
const manseSSSG = require('../manseSSSG/manseSSSG');
const checkSeunElement = require('../checkSeunElement/checkSeunElementIF');
const shgj = require('../gungShgj/gungshgjTest');
const shgjIF = require('../gungShgj/gungshgjIF');
const deun = require('../deunSeun/deunTest');
const deunV2 = require('../deunSeun/deunTestV2');
...
resultFunc.resultFunc = async function (res, name, contents) {
  if (checkError() === true) {
    ...
    await manseSSSG.manseSSSG();
    // await ryeong.ryeong();
    await chiguk.chiguk();
    await shgjIF.gungShgj();
    await deun.deun();
    await deunV2.deun();
    // await checkSeunElement.seunElementIF();
    await palpum.palpum();
