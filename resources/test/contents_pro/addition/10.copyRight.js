...
const self = () => {
  ...
  else if (checktwo_one()==='Y') {
    result.type='투자'
    result.keyword=getResult('Investment1',keyword).contents
  }
  else if (checktwo_two()==='Y') {
    result.type='투자'
    result.keyword=getResult('Investment2',keyword).contents
  }
