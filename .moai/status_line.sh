...
if [ -f "/Users/jwmudfish/go/bin/moai" ]; then
	exec "/Users/jwmudfish/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/jwmudfish/.local/bin/moai" ]; then
	exec "/Users/jwmudfish/.local/bin/moai" statusline < "$temp_file"
fi
