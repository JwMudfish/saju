...
jijangganFunc.jijanggan = function () {
  return new Promise((resolve) => {
    let year_jijanggan = getjijanggan.jijganggan(usePillar.y_land);
    let month_jijanggan = getjijanggan.jijganggan(usePillar.m_land);
    let day_jijanggan = getjijanggan.jijganggan(usePillar.d_land);
    let hour_jijanggan = getjijanggan.jijganggan(usePillar.h_land);
